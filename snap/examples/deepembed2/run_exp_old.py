...
from exputils_old import collect_temp_cpp_time, get_result_summary
...
def main():
	...
	get_result_summary(RESULT_NAME)

	#get_time_summary(GRAPN_ABBR, NUM_COM)
	#get_predication_summary(GRAPN_ABBR, NUM_COM)
